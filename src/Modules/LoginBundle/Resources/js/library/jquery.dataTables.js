	...
	var DataTable = function( oInit )
	{
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			var
                ...
                sTotalPaginado = oSettings.fnFormatNumber( oSettings._iDisplayStart )
                               + oSettings.fnFormatNumber( oSettings.fnRecordsDisplay() ),
			...
			else if ( oSettings.fnRecordsDisplay() == oSettings.fnRecordsTotal() )
			{
				...
				sOut = oSettings.oLanguage.sInfo.
						...
						replace('_END_',   sEnd).
                        replace('_PAGINADO_', sTotalPaginado).
		...
		function _fnPageChange ( oSettings, mAction )
		{
			...
			else if ( mAction == "next" )
			{
				if ( oSettings._iDisplayLength >= 0 )
				{
					...
					if ( oSettings._iDisplayStart + oSettings._iDisplayLength < oSettings._iRecordsTotal )
					{
						oSettings._iDisplayStart += oSettings._iDisplayLength;
					}
				}
