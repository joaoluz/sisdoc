...
!function( $ ) {
	...
	Datepicker.prototype = {
		...
		show: function(e) {
			...
			$(window).on('resize', $.proxy(this.place, this));
                        // DESABILITADO: comportamento inútil, causa problemas ao forçarmos o foco
                        /*
			if (e ) {
				e.stopPropagation();
				e.preventDefault();
	...
	$.fn.bsDatepicker = function ( option ) {
		...
		return this.each(function () {
			...
			if (!data) {
				$this.data('datepicker', (data = new Datepicker(this, $.extend({}, $.fn.bsDatepicker.defaults,options))));
			}
